...
readme_md = '''# 🎯 Visa Slot Booking Automation System
...
├── visa_automation.py     # Core automation logic
├── captcha_solver.py      # CAPTCHA solving system
├── slot_checker.py        # Slot monitoring system
