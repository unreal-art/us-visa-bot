# Fix the main.py file with proper string formatting
...
Examples:
  ...
  python main.py --check-only      # Only check for slots, don't book
        '''
    )
    ...
    parser.add_argument('--check-only', action='store_true',
                       help='Only check for available slots, don\\'t attempt booking')
